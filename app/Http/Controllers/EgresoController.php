...
class EgresoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'imagen_recibo' => 'nullable|image|max:2048',
        ]);
        ...
        $imagenPath = $request->hasFile('imagen_recibo')
            ? $request->file('imagen_recibo')->store('egresos', 'public')
            : null;
        ...
        $caja->decrement('saldo', $validated['monto']);
